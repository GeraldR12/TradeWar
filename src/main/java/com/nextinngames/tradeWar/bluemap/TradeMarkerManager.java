...
/**
 * Bridges live TradeWar/Towny state to BlueMap markers. This is the only class in the
 * integration that touches BlueMapAPI/Towny/Bukkit directly; keeps its own bookkeeping
 * of which town markers it placed and in which world, so a targeted refresh only ever
 * touches the marker(s) that actually changed instead of rebuilding the whole layer.
 */
